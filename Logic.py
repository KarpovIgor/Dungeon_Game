...
class GameEngine:
    """
    Базовый класс создания игровой логики

    Реализует наблюдателя для всплывающих окон
    В целом всё ясно и понятно
    по заданию лезть сюда не нужно
    """
    objects = []
    map = None
    hero = None
    ...
    def interact(self):
        """
        Тут покоиться логика взаимодействия героя с объектами на карте
        """
    ...
    # MOVEMENT
    # иди если не стена в конце считаем взаимодействия
